...
- [ ] FOLLOW-UP (security): tighten `/api/scheduled/daily-recap-send` auth gate — currently permissive (`authenticateRequest(req).catch(() => null)`), should require role==='user'||'admin' to match other scheduled routes.
